  ...
  def _update(self, c):
    ...
    if self.CS.hyundai_driving_mode:
      if self.CS.accel_profile != self.CS.accel_profile_prev:
        if self.CS.accel_profile == custom.AccelerationPersonality.normal:
          events.add(car.CarEvent.EventName.accelProfileNormal)
        elif self.CS.accel_profile == custom.AccelerationPersonality.eco:
          events.add(car.CarEvent.EventName.accelProfileEco)
        elif self.CS.accel_profile == custom.AccelerationPersonality.sport:
